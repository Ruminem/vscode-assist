...
check('after a call', leftOfDot('  foo()'), 'expression');
check('after a member call', leftOfDot('  pMgr->First()'), 'expression');
check('after a subscript', leftOfDot('  v[0]'), 'expression');
check('after a cast', leftOfDot('  static_cast<A*>(p)'), 'expression');
check('after parentheses', leftOfDot('  (*pp)'), 'expression');
